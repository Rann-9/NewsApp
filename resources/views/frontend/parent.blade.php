...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('zen/assets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('zen/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url({{ 'zen/assets/img/post-slide-1.jpg' }});">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url({{ 'zen/assets/img/post-slide-2.jpg' }});">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url({{ 'zen/assets/img/post-slide-3.jpg' }});">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url({{ 'zen/assets/img/post-slide-4.jpg' }});">
                                        <div class="img-bg-inner">
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{ asset('zen/assets/img/post-landscape-1.jpg') }}"
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('zen/assets/img/person-1.jpg') }}"
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('zen/assets/img/post-landscape-5.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('zen/assets/img/post-landscape-7.jpg') }}" alt=""
                                            class="img-fluid"></a>
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('zen/assets/img/post-landscape-3.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('zen/assets/img/post-landscape-6.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('zen/assets/img/post-landscape-8.jpg') }}" alt=""
                                            class="img-fluid"></a>
